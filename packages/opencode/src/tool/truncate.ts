...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const cleanup = Effect.fn("Truncate.cleanup")(function* () {
      // olderThan compares each id on its own time scale (wide vs legacy
      // encoding) — minting a cutoff id and comparing raw timestamps would
      // mis-rank legacy entries against a wide cutoff.
      ...
      for (const entry of entries) {
        if (!Identifier.olderThan(entry, cutoffMs)) continue
